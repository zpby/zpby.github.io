  ...
  <div class="ArticleSection">
    ...
    <div class="article" v-else>
      ...
      <ul>
        ...
        <li>
          • 作者:
          <router-link :to="{ name:'user_info',params:{name:post.author.loginname }}">{{ post.author.loginname }}
          </router-link>
        </li>
      </ul>
    ...
    <div id='reply'>
      <div v-for='(reply,index) in post.replies' class='replySec'>
        <div class='replyUp'>
          <router-link :to='{name: "user_info",params:{name: reply.author.loginname}}'><img
            :src='reply.author.avatar_url'></router-link>
          <router-link :to='{name: "user_info",params:{name: reply.author.loginname}}'>{{reply.author.loginname}}
          </router-link>
          <span>
       			    	{{index + 1}}楼
       			    </span>
